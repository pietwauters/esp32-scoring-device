...
Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, -1); // -1 for default I2C address (0x3C)
...
/*  // put your main code here, to run repeatedly:
  ...
  if (button->stateHasChanged()) {
      MySerial.println(button->isPressed() ? "Button Pressed" : "Button Released");
  }
*/
